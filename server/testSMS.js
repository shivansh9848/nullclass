...
async function testWhatsAppFeature() {
  ...
  const testNumbers = [
    ...
    "9876543210", // Valid (10-digit Indian format)
    "8765432109", // Valid (10-digit Indian format)
    "+15678901234", // Valid (US number)
    "5678901234", // Invalid (starts with 5)
  ...
  if (!process.env.TWILIO_SID || !process.env.TWILIO_TOKEN) {
    ...
    console.log(
      "  3. Join the sandbox by sending a WhatsApp message to +1 415 523 8886"
    );
  ...
  console.log(
    "3. Replace test phone numbers with your actual phone number (with country code)"
  );
